...
# Install powerdns 4.1.1
RUN curl https://downloads.powerdns.com/releases/pdns-4.1.1.tar.bz2 | tar xvjf -

RUN cd pdns-4.1.1 && ./configure --with-modules=remote && make && make install 
