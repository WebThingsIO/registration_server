...
# Install powerdns 4.1.0
RUN curl https://downloads.powerdns.com/releases/pdns-4.1.0.tar.bz2 | tar xvjf -

RUN cd pdns-4.1.0 && ./configure --with-modules=remote && make && make install 
